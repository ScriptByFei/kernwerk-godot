extends SceneTree
const OUT := "res://qa/artifacts/pipe-tile-v1/"
...
func _run() -> void:
	...
	var bounds := Rect2i(Vector2i(0, 0), Vector2i(112, 932))
	...
	if not FileAccess.file_exists(baseline_path):
		baseline_path = "res://qa/artifacts/pipe-tile-v1/baseline.gd.txt"
